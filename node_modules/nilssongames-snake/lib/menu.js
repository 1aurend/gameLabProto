...
var menu = {
      draw: function draw(context, game) {
...
var _temp = function () {
      ...
      __REACT_HOT_LOADER__.register(states, 'states', 'src/menu.js');

      __REACT_HOT_LOADER__.register(difficulty, 'difficulty', 'src/menu.js');

      __REACT_HOT_LOADER__.register(menu, 'menu', 'src/menu.js');

      __REACT_HOT_LOADER__.register(_default, 'default', 'src/menu.js');
}();
